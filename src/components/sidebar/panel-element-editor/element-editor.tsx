  ...
  initAttrData(
    ...
    switch (element.prototype) {
      ...
      case 'holes': {
        ...
        const startAt =
          lineLength * element.offset - element.properties.width.length / 2;
        ...
        const endAt =
          ...
          element.properties.width.length / 2;
    ...
    if (propertiesFormData) {
      const properties = Object.keys(propertiesFormData).reduce(
        (acc, key) => {
          ...
          acc[key] =
            data && data.currentValue !== undefined
              ? data.currentValue
              : undefined;
          return acc;
        },
      ...
      <div>
        ...
        <div style={attrPorpSeparatorStyle}>
          <div style={headActionStyle}>
            ...
            {appState.clipboardProperties &&
              appState.clipboardProperties.size ? (
              <div
